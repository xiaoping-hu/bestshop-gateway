...
export const ProductDetail = (props: IProductDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="gatewayApp.productProduct.detail.title">Product</Translate> [<b>{productEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="imageUrl">
              <Translate contentKey="gatewayApp.productProduct.imageUrl">Image Url</Translate>
            </span>
          </dt>
